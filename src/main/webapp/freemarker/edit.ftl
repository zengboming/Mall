...
<body>
<#include "/support.ftl">
<#include "/header.ftl"><div class="g-doc">
    ...
    <#else>
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/spring-mall/mall/editSubmit" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt ipt" name="summary" value="${product.abstract}" placeholder="2-140字符"／>
                </div>
            </div>
            <div class="fmitem">
